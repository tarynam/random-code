...
treatment_colors<-rep(c(brewer.pal(4, "Set1")), 8)

myCols <- cbind(condition_colors,treatment_colors)
colnames(myCols)[1] <- "Car Name"
...
heatmap.plus(input, col=bluered(20),cexRow=1,cexCol=0.2, main="Your Title",
